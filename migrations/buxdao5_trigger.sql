-- Function to manage BUXDAO 5 role
...
-- Create trigger
DROP TRIGGER IF EXISTS trigger_manage_buxdao5_role ON user_roles;
CREATE TRIGGER trigger_manage_buxdao5_role
  BEFORE INSERT OR UPDATE
  ON user_roles
  FOR EACH ROW
  EXECUTE FUNCTION manage_buxdao5_role(); 