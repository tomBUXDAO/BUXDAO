    ...
    <section className="min-h-screen pt-20 bg-gradient-to-b from-black to-purple-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-10 gap-8">
          <div className="col-span-10 lg:col-span-7 pr-0 lg:pr-12">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-8">
              100% community owned and managed
            </h1>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-gray-300 mb-8">
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 mb-8">
              <button className="w-full sm:w-auto bg-gradient-to-r from-purple-500 to-pink-500 px-8 py-3 rounded-full text-white text-lg hover:opacity-90 transition-opacity">
                Explore Collection
              </button>
              <button className="w-full sm:w-auto border-2 border-white px-8 py-3 rounded-full text-white text-lg hover:bg-white hover:text-black transition-all">
                Learn More
              </button>
            </div>
          </div>
      ...
      <div className="w-full bg-gray-950/80 border-t border-b border-gray-800">
        <div className="py-6 overflow-hidden">
          <div className="relative">
            <div className="flex animate-scroll gap-6 sm:gap-12 whitespace-nowrap">
              {[...gifs, ...gifs].map((gif, index) => (
                <div 
                  key={index} 
                  className="w-48 h-48 sm:w-64 sm:h-64 flex-shrink-0 rounded-xl overflow-hidden bg-gray-900 shadow-xl transform hover:scale-105 transition-transform duration-300"
                >
                  <img 
                    src={gif} 
