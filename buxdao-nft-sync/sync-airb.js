...
const COLLECTION = {
  name: 'AIRB',
  address: '4obz5pRAjZyV2zE4dbpSfhtagQcWt6W3UdJ6FqsCGnLE'
};
...
// Main sync function
async function syncRejectedBots() {
  if (TEST_MODE) {
  ...
  try {
    console.log('\nStarting REJECTED BOTS NFT ownership sync...');
...
export default syncRejectedBots;