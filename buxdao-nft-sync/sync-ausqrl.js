...
const COLLECTION = {
  name: 'AUSQRL',
  address: 'GLN64oj3rQq4qy93P9YV5xF8U2veiFcGbGaTTZQhPoj5'
};
...
// Main sync function
async function syncAISquirrels() {
  if (TEST_MODE) {
  ...
  try {
    console.log('\nStarting AI SQUIRRELS NFT ownership sync...');
...
export default syncAISquirrels;